...
## Example of Existing Chaincode with AuthInfo and CertInfo Management

This chaincode is created to control on the AuthInfo and CertInfo Management Information in file `main.go`
